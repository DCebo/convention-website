...
export const FACTIONS: Record<FactionId, Faction> = {
  'vaultbreakers': {
    ...
    description: 'Swift Strikers of the First Find. Vaultbreakers believe the best treasures go to those who seize them first. Masters of rapid appraisal and quick deals, they swoop in before rivals even notice a prize is on the table. They wear crimson sashes to symbolize the rush of the first claim.',
  ...
  'riftwalkers': {
    ...
    description: 'Opportunists of the Shifting Market. Riftwalkers have mastered the art of leaping between worlds — and deals — before others know they exist. They thrive on unpredictability, chasing rare finds wherever the multiverse opens a door. Their purple cloaks shimmer like the edges of the rifts they travel.',
  ...
  'chronoguards': {
    ...
    description: 'Coordinated Keepers of Time. Chronoguards believe history belongs to those who work in harmony. Masters of synchronized acquisitions, they know that a single collector is strong, but a united guild is unstoppable. Their blue sigil is shaped like an hourglass, marking their mastery of timing and teamwork.',
...
export const FACTION_CONTEST: FactionContest = {
  ...
  description: 'For centuries, the Collector\'s Guild has quietly ruled the Multiverse Market — a hidden nexus where worlds collide and treasures beyond imagination are traded. Every decade, the Guild gathers at Collect-It Con to determine which faction will hold the Golden Seal, the mark of supreme collecting prestige. This year, the Seal is up for grabs. Four legendary guilds are vying for dominance — each with a unique philosophy, trading style, and field strategy.',
  ...
  prizes: {
    first: 'The Golden Seal of the Collector\'s Guild, faction banner raised in the Guild Hall, names etched in the Guild Ledger, and premium collector\'s vault',
    second: 'Silver Seal of Honor, special edition faction collector set, and $300 marketplace credit',
    third: 'Bronze Seal of Recognition, commemorative faction pack, and $200 marketplace credit',
    participation: 'Faction membership certificate, exclusive faction insignia, and Guild Chronicles participation badge'
  },
  pointsPerDollar: 1,
  bonusActivities: [
    {
